class GetTextForValue {
  ...
  static String get(double value) {
    return switch(valueType){
      "pm10" => getTextForPm10(value),
      "pm25" => getTextForPm25(value),
      "temperature" => getTextForTemperature(value),
      "humidity" => getTextForHumidity(value),
      "pressure" => getTextForPressure(value),
      _ => getTextForNoise(value)
    };
  }

  static String getTextForPm10(double value){
  ...
  static String getTextForPm25(double value){
  ...
  static String getTextForTemperature(double value){
  ...
  static String getTextForHumidity(double value){
  ...
  static String getTextForPressure(double value){
  ...
  static String getTextForNoise(double value){
